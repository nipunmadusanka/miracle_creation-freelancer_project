...
<i class="fa fa-star-o" aria-hidden="true"></i>
<?php } ?></td>
                <td><a href="select_order.php?select=<?php echo $row['ID'];?>"><div class="inner" style="background-color: rgba(67, 89, 145, 0.9); border-radius: 8px;"><p style="    margin: 0 0 0 0;">select</p></div></a></td>
                 <!-- -->
                </tr>
                <tr>
