			...
			<div class="box wow fadeInUp" style="width: 55%;">
				<div class="inner">                                                 
					 ...
					 <form action="" method="post" onsubmit="return Validate()" enctype="multipart/form-data" class="form-horizontal" name="Aform">
						...
						<fieldset>
							<input type="text" name="fullname" class="textInput" placeholder="My name" title="user name">
						</fieldset>
						...
						<fieldset>
							<input type="text" name="livecity" class="textInput" placeholder="My City" title="live city">
						</fieldset>
  ...
  <i id="number" class="invalid">A number ||</i>
   <i id="length" class="invalid">Minimum 8 characters </i>
						...
						<fieldset style="padding-top: 18px;">
							...
							<div id="terms_div">
								<label style="float: left;"><a href="T&C.php" target="_blank">agree terms and condition</a></label>
