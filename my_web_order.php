...
<head>
  <meta charset="utf-8">
  <title>My Web Order || <?php  echo $row['name'];?></title>
...
<div class="main">
  <div class="inner" style="padding-top: 10em;">
     <center><h2>My Web Order</h2> </center> 
    <div class="thumbnails">
      <div class="content">
       <div class="thumbnails1" style="width: 70%;background-color: white;">

      <?php 
$ret=mysqli_query($con," SELECT * FROM web_order WHERE order_read ='' && user_id='$cid'");
while ($row=mysqli_fetch_array($ret)) {
?>
...
<p>
 Order Date :
<i style="color: white;"><?php  echo $row['date'];?></i>
</p> 
<p>
  Payment Method :
...
<p>
  Package :
<i style="color: white;"><?php  echo $row['package'];?></i>
</p>
<p>
Complete :
<?php  $x=$row['order_read'];
    if ($x=='read') {
      echo "YES";
    }
    else{
...
contact us :- <a href="tel:0786880038">0786880038</a>
</p>
<p>
  Admin Message :
<i style="color: white;"><?php  echo $row['a_msg'];?></i><br>
<i>
 My Message :
...
<div class="box2" >
 ...
 $msg=$_POST['msg'];
 $id=$_POST['id'];
$query=mysqli_query($con,"update web_order set u_msg='$msg' where order_read ='' && user_id='$cid' && ID='$id'");
if($query){
...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
  ...
  <button type="submit" name="submit" title="send">Send</button>
        ...
        <?php 
$ret=mysqli_query($con," SELECT * FROM web_order WHERE order_read ='' && user_id='$cid' && ID='$id'");
...
<br><br><p>Show Message For Selected Id</p>
 ...
 $id1=$_POST['id1'];
$ret=mysqli_query($con," SELECT * FROM web_order WHERE order_read ='' && user_id='$cid' && ID='$id1'");
if ($row=mysqli_fetch_array($ret)) {
?>
<i>Order Id:</i>
