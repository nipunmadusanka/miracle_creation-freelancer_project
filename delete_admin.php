...
?><table border="1" style="border-width: 10px; border-color: red;">
  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            <button style="background-color: red;width: 6em;" type="submit" name="submit" title="Delete">Remove</button></form>
</td>
    </tr>
...
$cnt=$cnt+1;
  ...
  $query=mysqli_query($con,"DELETE FROM `miracle`.`admin` WHERE `admin`.`ID` = '$id' ");
if($query){
