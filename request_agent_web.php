...
<div class="main">
  <div class="innerr">
    ...
    <div class="thumbnails" style="padding-top: 5em; ">
        ...
        <div class="inner">
                <form name="search" action="search_request_web_agent.php" method="post">
                                <input type="text" name="searchdata" placeholder="Search by names, mobile number, livecity , id..." />
  ...
  <?php
  $ret=mysqli_query($con,"select * from  agents where job_list like '%Website Developer%'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?><table border="1" style="border-width: 10px; border-color: red;">
  <tr>
    <td>Request WEB Agent <?php echo $cnt; ?> </td>
  </tr>
      <tr>
    <th>User ID</th>
    <th>Date</th>
