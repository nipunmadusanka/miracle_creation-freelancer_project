...
<head>
  <meta charset="utf-8">
  <title>Complete Web Orders || <?php  echo $row['Name'];?></title>
...
include_once('include/admin_menubar.php');
 ?>
  ...
  <div class="inner" style="padding-top: 10em;">
     <center><h2>Complete Web Orders</h2> </center> 
      ...
      <div class="content">
       <div class="thumbnails1" style="width: 70%;">
                ...
                <table border="1" class="mg-b-0" style="background-color: gray;">
                   <?php
$id=$_GET['id'];
$ret=mysqli_query($con,"select * from web_order where order_read ='read' && ID='$id'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
  ?>
  <tr>
...
<div class="box2" >
 ...
 $msg=$_POST['msg'];
$id=$_GET['id'];
$query=mysqli_query($con,"update web_order set a_msg='$msg' where order_read ='read' && ID='$id'");
if($query){
