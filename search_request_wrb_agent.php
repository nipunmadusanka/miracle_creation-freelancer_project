...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
                                      <?php
$ret=mysqli_query($con,"select *from agents where (username like '$sdata%'||mobilenumber like '$sdata%'|| livecity like '$sdata%' || job_list like '$sdata%' || ID like '$sdata%') and job_list like '%Website Developer%'");
