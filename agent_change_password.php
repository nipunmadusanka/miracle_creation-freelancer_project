...
?>  
  ...
  <label>New password</label>
      ...
      <button type="submit" name="submit" id="btnSubmit" onclick="return Validate()">Change</button>
</form>
...
if ($psw==$oldPassword) {
$query=mysqli_query($con,"update agent set password='$newPassword' where  ID='$aid' ");
if($query){
