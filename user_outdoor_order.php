...
$query=mysqli_query($con,  "insert into outdoor_order(agent_id,user_id,name,telephone,email,address,city,order_type,description,status_of_the_project,required_date,payment,created) value('$a_id','$user_id','$name','$number','$email','$address','$city','$type','$description','$status','$r_date','$payment','$created')");
if ($query) {
    # code...
...
<head>
  <meta charset="utf-8">
  <title>miracle creation outdoor order || <?php  echo $row['name'];?></title>
...
<script src="assets/js/user_outdoor_validation.js"></script>
