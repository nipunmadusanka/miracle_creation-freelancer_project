...
include_once('include/agent_menubar.php');
 ...
 // $eid=$_SESSION['adid'];
$ID=$_GET['id'];
$ret=mysqli_query($con,"select * from  normal_order where ID ='$ID' && agent_id='$eid' && agent_read='read'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
	?>
<tr>
...
<tr>
	...
	<td><?php echo $row['agent_file_upload']; ?></td>                
</tr>
<tr>
	<th></th>
    <td><a href="uploads/agent complete/normal/<?php echo $row['agent_file_upload']; ?>" download>Download</td>
</tr>
 <tr>
 	<th></th>
 <td>     <!--  -->
