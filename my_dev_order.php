...
<div class="main">
  <div class="inner" style="padding-top: 10em;">
    ...
    <div class="thumbnails">
      ...
      <?php 
$ret=mysqli_query($con," SELECT * FROM  dev_order WHERE agent_read ='' && user_id='$cid'");
while ($row=mysqli_fetch_array($ret)) {
?>
...
<div class="box2" >
 ...
 $msg=$_POST['msg'];
 $id=$_POST['id'];
$query=mysqli_query($con,"update dev_order set msg='$msg' where agent_read ='' && user_id='$cid' && ID='$id'");
if($query){
...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
  ...
  <button type="submit" name="submit" title="send">Send</button>
        ...
        <?php 
$ret=mysqli_query($con," SELECT * FROM dev_order WHERE agent_read ='' && user_id='$cid' && ID='$id'");
...
<br><br><p>Show Message For Selected Id</p>
 ...
 $id1=$_POST['id1'];
$ret=mysqli_query($con," SELECT * FROM dev_order WHERE agent_read ='' && user_id='$cid' && ID='$id1'");
if ($row=mysqli_fetch_array($ret)) {
?>
<i>Order Id:</i>
