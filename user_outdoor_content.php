...
<body id="top" style="background-image: url('images/outdoor.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
<?php } ?>
<?php 
...
<?php
$eid=$_GET['editid'];
if('Photograper'==$eid || 'Home Wiring'==$eid || 'CCTV Installation'==$eid || 'Wedding Photography'==$eid || 'Family Photography'==$eid || 'Sports Photography'==$eid || 'Wildlife Photography'==$eid || 'Adventure Photography'==$eid || 'Commercial Photography'==$eid || 'Drone Photography'==$eid || 'Indoor Photography'==$eid || 'Lifestyle Photography'==$eid || 'Pet Photography'==$eid || 'Social Media Photography'==$eid || 'Travel Photography'==$eid || 'Fashion Photography'==$eid || 'Advertising Photography'==$eid || 'Landscape Photography'==$eid || 'Food Photography'==$eid || 'Editorial Photography'==$eid || 'Event Photography'==$eid){
?>
...
<?php } ?>
                ...
                <tr><th>Intrested In </th><a href="user_outdoor_order.php?select=<?php echo $row['ID'];?>"><td><button class="button" style="background-color: rgba(67, 89, 145, 0.9);">Yes</button></a></td></tr>
                 <!-- -->
