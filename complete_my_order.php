...
<head>
  <meta charset="utf-8">
	<title>Complete My Orders || <?php  echo $row['name'];?></title>
...
<div class="box wow fadeInDown" style="background-color: #0c0514;">
        <div class="inner">
 <a href="my_complete_web_order.php">        
  <h4>Web Orders</h4>
  <?php 
$ret=mysqli_query($con," SELECT COUNT(*) FROM web_order WHERE order_read ='read' && user_id='$cid'");
while ($row=mysqli_fetch_array($ret)) {
?>
...
<div class="box wow fadeInDown" style="background-color: #0c0514;">
        <div class="inner">
         <a href="my_complete_dev_order.php">
...
<div class="box wow fadeInDown" style="background-color: #0c0514;">
        <div class="inner">
         <a href="my_complete_normal_order.php">
  <h4>Normal Orders</h4>
  <?php 
...
<div class="box wow fadeInDown" style="background-color: #0c0514;">
        <div class="inner">
          <a href="my_complete_outdoor_order.php">
