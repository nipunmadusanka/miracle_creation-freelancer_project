...
$ret=mysqli_query($con,"select * from  outdoor_order where agent_read ='' && agent_id='$eid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
	?>
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <!-- -->
 <td>     <!--  -->
<a href="agent_outdoor_order_view.php?id=<?php echo $row['ID'];?>"><button style="background-color: rgba(100, 30, 250, 0.7);width: 6em;"title="complete">view</button></a>
</td>
</tr>
<?php $cnt=$cnt+1; } ?>
</table>
